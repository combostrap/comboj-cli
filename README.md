...
* A command is called a [CliCommand](src/main/java/com/combostrap/cli/CliCommand.java)
* A CliCommand can have children [CliCommand](src/main/java/com/combostrap/cli/CliCommand.java)
* The cli is the root CliCommand on the tree (the first one created)
* A CliCommand expects a list of [word](src/main/java/com/combostrap/cli/CliWord.java) that are categorized as:
  * command
  * flag
  * property
  * argument
